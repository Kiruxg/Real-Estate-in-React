...
changeView(viewName){
  ...
  render () {
    return (<div>
            ...
            <h3 className='positioningtext'>Find your next home</h3>
           ...
           <Listings filteredData = {this.state.filteredData} change = {this.change} globalState= {this.state} changeView = {this.changeView} />
            ...
            <h4>Download the LocalHomes App</h4>
            ...
            <button>
              ...
              <p className='copyrighttext'>2006-2018 LocalHomes.com</p>
            </div>
            <img src='/img/localhomes.png'/>
            </section>
            <section className='additionalinfo'> 
                <ul>
                    <li><a href='#top'>LocalHomes.com</a></li>
                    <li>About LocalHomes.com</li>
                    <li>Meet the realtors</li>
                    <li>LocalHomes App</li>
                    <li>Work with Us</li>
                </ul>
            </section>
            </footer>
